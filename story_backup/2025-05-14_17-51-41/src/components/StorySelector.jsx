...
// This component renders the main story selection screen with navigation and story cards
...
const playerFlags = JSON.parse(localStorage.getItem("playerFlags") || "[]");

const isAfterwardUnlocked =
  playerFlags.includes("read_DNR") &&
  playerFlags.includes("wrote_fuck_you_letter");

// Story metadata array (dynamic)
const stories = [
...
=======
// Add Final Protocol Afterward conditionally
if (isAfterwardUnlocked) {
  stories.push({
    title: "📲 Final Protocol: Root Access",
    note: "Unlocked — the nurse remembers everything.",
    route: "/ai_endgame"
  });
} else {
  stories.push({
    title: "???",
    note: "Coming soon — or never, if you give up.",
    route: null
  });
}
